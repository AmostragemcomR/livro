...
<center>
```{r, figcalib1, echo=FALSE, encoding="UTF-8", fig.cap="Residuos para o modelo de regressão da população para os estimadores de HT (esquerda) e de calibração (direita)",out.width = '70%'}
...
<center>
```{r, figcalib3, echo=FALSE, encoding="UTF-8", fig.cap="EQM do estimador de regressão *versus* número de variáveis auxiliares",out.width = '50%'}
